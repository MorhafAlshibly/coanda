...
func Test_DeleteEvent_ById_EventDeleted(t *testing.T) {
	...
	if row.Name != "event170" {
		t.Fatalf("expected name to be event170, got %s", row.Name)
	}
}
...
func Test_DeleteEvent_ByName_EventDeleted(t *testing.T) {
	...
	if row.Name != "event180" {
		t.Fatalf("expected name to be event180, got %s", row.Name)
	}
}
...
func Test_DeleteEventRoundUser_ByEventRoundUserId_EventRoundUserDeleted(t *testing.T) {
	...
	result, err = q.DeleteEventRoundUser(context.Background(), uint64(eventRoundUserId))
	if err != nil {
