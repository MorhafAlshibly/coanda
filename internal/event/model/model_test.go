...
func Test_GetEventWithRound_ByIDEventDoesNotExist_EventNotReturned(t *testing.T) {
	q := New(db)
	_, err := q.GetEventWithRound(context.Background(), GetEventParams{
		ID: sql.NullInt64{Int64: 99999, Valid: true},
	})
	if err == nil {
		t.Fatalf("expected error, got nil")
...
func Test_GetEventLeaderboard_ByIDEventDoesNotExist_EventLeaderboardNotReturned(t *testing.T) {
	q := New(db)
	_, err := q.GetEventLeaderboard(context.Background(), GetEventLeaderboardParams{
		Event: GetEventParams{
			ID: sql.NullInt64{Int64: 99999, Valid: true},
		},
		Limit:  2,
...
func Test_GetEventLeaderboard_ByIDMultipleEventRounds_EventLeaderboardReturned(t *testing.T) {
	...
	result, err = db.ExecContext(context.Background(), `INSERT INTO event_round_user (event_user_id, event_round_id, result, data) VALUES (?, ?, ?, ?);`, eventUserId1, eventRoundId2, 8, `{}`)
	if err != nil {
		t.Fatalf("could not create event round user: %v", err)
	}
	result, err = db.ExecContext(context.Background(), `INSERT INTO event_round_user (event_user_id, event_round_id, result, data) VALUES (?, ?, ?, ?);`, eventUserId2, eventRoundId2, 2, `{}`)
	if err != nil {
		t.Fatalf("could not create event round user: %v", err)
	}
	leaderboard, err := q.GetEventLeaderboard(context.Background(), GetEventLeaderboardParams{
	...
	if leaderboard[0].Score != 13 {
		t.Fatalf("expected score to be 13, got %d", leaderboard[0].Score)
	}
	if leaderboard[0].Ranking != 1 {
		t.Fatalf("expected ranking to be 1, got %d", leaderboard[0].Ranking)
	}
	...
	if leaderboard[1].Score != 11 {
		t.Fatalf("expected score to be 11, got %d", leaderboard[1].Score)
	}
	if leaderboard[1].Ranking != 2 {
		t.Fatalf("expected ranking to be 2, got %d", leaderboard[1].Ranking)
	}
...
func Test_GetEventRound_ByEventID_CurrentEventRoundReturned(t *testing.T) {
	...
	if eventRound.EndedAt != startedAt.Add(1*time.Hour) {
...
func Test_GetEventRoundUsers_ByEventUserID_EventRoundUsersReturned(t *testing.T) {
	...
	result, err = db.ExecContext(context.Background(), `INSERT INTO event_round_user (event_user_id, event_round_id, result, data) VALUES (?, ?, ?, ?);`, eventUserId, eventRoundId2, 2, `{}`)
	if err != nil {
		t.Fatalf("could not create event round user: %v", err)
	}
...
func Test_GetEventRoundUsers_ByEventUserIDEventUserDoesNotExist_EventRoundUsersNotReturned(t *testing.T) {
	q := New(db)
	_, err := q.GetEventRoundUsers(context.Background(), GetEventRoundUsersParams{
		EventUser: GetEventUserParams{
			ID: sql.NullInt64{Int64: 99999, Valid: true},
		},
		Limit:  2,
...
func Test_DeleteEventRoundUser_ByEventRoundUserId_EventRoundUserDeleted(t *testing.T) {
	...
	_, err = db.ExecContext(context.Background(), `SELECT * FROM event_round_user WHERE id = ?;`, eventRoundUserId)
	if err == nil {
		t.Fatalf("expected error, got nil")
	}
	if err != sql.ErrNoRows {
...
func Test_DeleteEventRoundUser_ByEventUserIdAndRoundName_EventRoundUserDeleted(t *testing.T) {
	...
	result, err = db.ExecContext(context.Background(), `SELECT * FROM event_round_user WHERE id = ?;`, eventRoundUserId)
	if err == nil {
		t.Fatalf("expected error, got nil")
	}
	if err != sql.ErrNoRows {
