...
type MatchmakingMatchWithArenaAndTicket struct {
	...
	TicketArenaMinPlayers          sql.NullInt16   `db:"ticket_arena_min_players"`
	TicketArenaMaxPlayersPerTicket sql.NullInt16   `db:"ticket_arena_max_players_per_ticket"`
	TicketArenaMaxPlayers          sql.NullInt16   `db:"ticket_arena_max_players"`
...
type MatchmakingTicketWithUserAndArena struct {
	...
	ArenaMinPlayers          uint8           `db:"arena_min_players"`
	ArenaMaxPlayersPerTicket uint8           `db:"arena_max_players_per_ticket"`
	ArenaMaxPlayers          uint8           `db:"arena_max_players"`
	ArenaNumber              interface{}     `db:"arena_number"`
	ArenaData                json.RawMessage `db:"arena_data"`
