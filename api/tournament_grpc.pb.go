...
type TournamentServiceClient interface {
	...
	GetTournamentUser(ctx context.Context, in *GetTournamentUserRequest, opts ...grpc.CallOption) (*GetTournamentUserResponse, error)
	...
	UpdateTournamentUserScore(ctx context.Context, in *UpdateTournamentUserScoreRequest, opts ...grpc.CallOption) (*GetTournamentUserResponse, error)
	UpdateTournamentUserData(ctx context.Context, in *UpdateTournamentUserDataRequest, opts ...grpc.CallOption) (*GetTournamentUserResponse, error)
}
...
func (c *tournamentServiceClient) GetTournamentUser(ctx context.Context, in *GetTournamentUserRequest, opts ...grpc.CallOption) (*GetTournamentUserResponse, error) {
...
func (c *tournamentServiceClient) UpdateTournamentUserScore(ctx context.Context, in *UpdateTournamentUserScoreRequest, opts ...grpc.CallOption) (*GetTournamentUserResponse, error) {
	out := new(GetTournamentUserResponse)
...
func (c *tournamentServiceClient) UpdateTournamentUserData(ctx context.Context, in *UpdateTournamentUserDataRequest, opts ...grpc.CallOption) (*GetTournamentUserResponse, error) {
	out := new(GetTournamentUserResponse)
...
type TournamentServiceServer interface {
	...
	GetTournamentUser(context.Context, *GetTournamentUserRequest) (*GetTournamentUserResponse, error)
	GetTournamentUsers(context.Context, *GetTournamentUsersRequest) (*GetTournamentUsersResponse, error)
	UpdateTournamentUserScore(context.Context, *UpdateTournamentUserScoreRequest) (*GetTournamentUserResponse, error)
	UpdateTournamentUserData(context.Context, *UpdateTournamentUserDataRequest) (*GetTournamentUserResponse, error)
...
func (UnimplementedTournamentServiceServer) GetTournamentUser(context.Context, *GetTournamentUserRequest) (*GetTournamentUserResponse, error) {
...
func (UnimplementedTournamentServiceServer) UpdateTournamentUserScore(context.Context, *UpdateTournamentUserScoreRequest) (*GetTournamentUserResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method UpdateTournamentUserScore not implemented")
}
func (UnimplementedTournamentServiceServer) UpdateTournamentUserData(context.Context, *UpdateTournamentUserDataRequest) (*GetTournamentUserResponse, error) {
