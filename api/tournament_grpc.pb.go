...
type TournamentServiceClient interface {
	...
	GetTournamentUser(ctx context.Context, in *GetTournamentUserRequest, opts ...grpc.CallOption) (*TournamentUserResponse, error)
	...
	UpdateTournamentUserScore(ctx context.Context, in *UpdateTournamentUserScoreRequest, opts ...grpc.CallOption) (*TournamentUserResponse, error)
	UpdateTournamentUserData(ctx context.Context, in *UpdateTournamentUserDataRequest, opts ...grpc.CallOption) (*TournamentUserResponse, error)
	DeleteTournamentUser(ctx context.Context, in *GetTournamentUserRequest, opts ...grpc.CallOption) (*DeleteTournamentUserResponse, error)
}
...
func (c *tournamentServiceClient) GetTournamentUser(ctx context.Context, in *GetTournamentUserRequest, opts ...grpc.CallOption) (*TournamentUserResponse, error) {
...
func (c *tournamentServiceClient) UpdateTournamentUserScore(ctx context.Context, in *UpdateTournamentUserScoreRequest, opts ...grpc.CallOption) (*TournamentUserResponse, error) {
	out := new(TournamentUserResponse)
	err := c.cc.Invoke(ctx, "/api.TournamentService/UpdateTournamentUserScore", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *tournamentServiceClient) UpdateTournamentUserData(ctx context.Context, in *UpdateTournamentUserDataRequest, opts ...grpc.CallOption) (*TournamentUserResponse, error) {
	out := new(TournamentUserResponse)
	err := c.cc.Invoke(ctx, "/api.TournamentService/UpdateTournamentUserData", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *tournamentServiceClient) DeleteTournamentUser(ctx context.Context, in *GetTournamentUserRequest, opts ...grpc.CallOption) (*DeleteTournamentUserResponse, error) {
	out := new(DeleteTournamentUserResponse)
...
type TournamentServiceServer interface {
	...
	GetTournamentUser(context.Context, *GetTournamentUserRequest) (*TournamentUserResponse, error)
	GetTournamentUsers(context.Context, *GetTournamentUsersRequest) (*GetTournamentUsersResponse, error)
	UpdateTournamentUserScore(context.Context, *UpdateTournamentUserScoreRequest) (*TournamentUserResponse, error)
	UpdateTournamentUserData(context.Context, *UpdateTournamentUserDataRequest) (*TournamentUserResponse, error)
	DeleteTournamentUser(context.Context, *GetTournamentUserRequest) (*DeleteTournamentUserResponse, error)
...
func (UnimplementedTournamentServiceServer) GetTournamentUser(context.Context, *GetTournamentUserRequest) (*TournamentUserResponse, error) {
...
func (UnimplementedTournamentServiceServer) UpdateTournamentUserScore(context.Context, *UpdateTournamentUserScoreRequest) (*TournamentUserResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method UpdateTournamentUserScore not implemented")
}
func (UnimplementedTournamentServiceServer) UpdateTournamentUserData(context.Context, *UpdateTournamentUserDataRequest) (*TournamentUserResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method UpdateTournamentUserData not implemented")
}
func (UnimplementedTournamentServiceServer) DeleteTournamentUser(context.Context, *GetTournamentUserRequest) (*DeleteTournamentUserResponse, error) {
...
func _TournamentService_GetTournamentUser_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetTournamentUserRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TournamentServiceServer).GetTournamentUser(ctx, req.(*GetTournamentUserRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _TournamentService_UpdateTournamentUserScore_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(UpdateTournamentUserScoreRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(TournamentServiceServer).UpdateTournamentUserScore(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/api.TournamentService/UpdateTournamentUserScore",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TournamentServiceServer).UpdateTournamentUserScore(ctx, req.(*UpdateTournamentUserScoreRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _TournamentService_UpdateTournamentUserData_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(UpdateTournamentUserDataRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(TournamentServiceServer).UpdateTournamentUserData(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/api.TournamentService/UpdateTournamentUserData",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TournamentServiceServer).UpdateTournamentUserData(ctx, req.(*UpdateTournamentUserDataRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _TournamentService_DeleteTournamentUser_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TournamentServiceServer).DeleteTournamentUser(ctx, req.(*GetTournamentUserRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var TournamentService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "UpdateTournamentUserScore",
			Handler:    _TournamentService_UpdateTournamentUserScore_Handler,
		},
		{
			MethodName: "UpdateTournamentUserData",
			Handler:    _TournamentService_UpdateTournamentUserData_Handler,
		},
		{
