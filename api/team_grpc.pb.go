...
const (
	TeamService_CreateTeam_FullMethodName      = "/api.TeamService/CreateTeam"
	TeamService_GetTeam_FullMethodName         = "/api.TeamService/GetTeam"
	TeamService_GetTeams_FullMethodName        = "/api.TeamService/GetTeams"
	TeamService_SearchTeams_FullMethodName     = "/api.TeamService/SearchTeams"
	TeamService_UpdateTeamData_FullMethodName  = "/api.TeamService/UpdateTeamData"
	TeamService_UpdateTeamScore_FullMethodName = "/api.TeamService/UpdateTeamScore"
	TeamService_DeleteTeam_FullMethodName      = "/api.TeamService/DeleteTeam"
	TeamService_JoinTeam_FullMethodName        = "/api.TeamService/JoinTeam"
	TeamService_LeaveTeam_FullMethodName       = "/api.TeamService/LeaveTeam"
)
...
func (c *teamServiceClient) SearchTeams(ctx context.Context, in *SearchTeamsRequest, opts ...grpc.CallOption) (*Teams, error) {
	out := new(Teams)
	err := c.cc.Invoke(ctx, TeamService_SearchTeams_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *teamServiceClient) UpdateTeamData(ctx context.Context, in *UpdateTeamDataRequest, opts ...grpc.CallOption) (*Team, error) {
	out := new(Team)
	err := c.cc.Invoke(ctx, TeamService_UpdateTeamData_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *teamServiceClient) UpdateTeamScore(ctx context.Context, in *UpdateTeamScoreRequest, opts ...grpc.CallOption) (*Team, error) {
	out := new(Team)
	err := c.cc.Invoke(ctx, TeamService_UpdateTeamScore_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *teamServiceClient) JoinTeam(ctx context.Context, in *JoinTeamRequest, opts ...grpc.CallOption) (*Team, error) {
	out := new(Team)
	err := c.cc.Invoke(ctx, TeamService_JoinTeam_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *teamServiceClient) LeaveTeam(ctx context.Context, in *LeaveTeamRequest, opts ...grpc.CallOption) (*Team, error) {
	out := new(Team)
	err := c.cc.Invoke(ctx, TeamService_LeaveTeam_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _TeamService_SearchTeams_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: TeamService_SearchTeams_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _TeamService_UpdateTeamData_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: TeamService_UpdateTeamData_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _TeamService_UpdateTeamScore_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: TeamService_UpdateTeamScore_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
