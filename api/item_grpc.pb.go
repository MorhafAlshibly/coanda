...
type ItemServiceClient interface {
	...
	GetItem(ctx context.Context, in *ItemRequest, opts ...grpc.CallOption) (*GetItemResponse, error)
...
func (c *itemServiceClient) GetItem(ctx context.Context, in *ItemRequest, opts ...grpc.CallOption) (*GetItemResponse, error) {
...
func (c *itemServiceClient) UpdateItem(ctx context.Context, in *UpdateItemRequest, opts ...grpc.CallOption) (*UpdateItemResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/api.ItemService/UpdateItem", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *itemServiceClient) DeleteItem(ctx context.Context, in *ItemRequest, opts ...grpc.CallOption) (*ItemResponse, error) {
	out := new(ItemResponse)
	err := c.cc.Invoke(ctx, "/api.ItemService/DeleteItem", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ItemServiceServer interface {
	...
	GetItem(context.Context, *ItemRequest) (*GetItemResponse, error)
...
func (UnimplementedItemServiceServer) GetItem(context.Context, *ItemRequest) (*GetItemResponse, error) {
...
func (UnimplementedItemServiceServer) DeleteItem(context.Context, *ItemRequest) (*ItemResponse, error) {
...
func _ItemService_UpdateItem_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/api.ItemService/UpdateItem",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _ItemService_DeleteItem_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/api.ItemService/DeleteItem",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
